...
_G.packer_plugins = {
  ...
  conform = {
    ...
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/conform",
  ...
  ["lazygit.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/lazygit.nvim",
...
-- Config for: conform
time([[Config for conform]], true)
try_loadstring("\27LJ\2\n5\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\fconform\frequire\0", "config", "conform")
time([[Config for conform]], false)
